-- main 의 V088_20260909__add_server_internal_base_url.sql 를 magic-card 로 옮긴 것이다. servers 표만 건드리므로 마법 모델과 무관하다.
--
-- 분류 B: magic-card 가 바꾼 표나 column 에 닿지 않아 원본 SQL 을 그대로 옮겼다.
-- 아래는 V088_20260909__add_server_internal_base_url.sql 의 내용 그대로다.
-- ---------------------------------------------------------------------------
