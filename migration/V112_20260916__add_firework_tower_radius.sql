-- main 의 V092_20260914__add_firework_tower_radius.sql 를 magic-card 로 옮긴 것이다. V109 가 등록한 firework_tower 뒤에 온다.
--
-- 분류 B: magic-card 가 바꾼 표나 column 에 닿지 않아 원본 SQL 을 그대로 옮겼다.
-- 아래는 V092_20260914__add_firework_tower_radius.sql 의 내용 그대로다.
-- ---------------------------------------------------------------------------
