-- main 의 V096_20260914__repoint_magic_id_parameter_rows.sql 를 magic-card 로 옮긴 것이다. magic_id parameter 행만 건드리고 cast_type 을 읽지 않는다.
--
-- 분류 B: magic-card 가 바꾼 표나 column 에 닿지 않아 원본 SQL 을 그대로 옮겼다.
-- 아래는 V096_20260914__repoint_magic_id_parameter_rows.sql 의 내용 그대로다.
-- ---------------------------------------------------------------------------
