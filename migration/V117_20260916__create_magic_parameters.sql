-- main 의 V099_20260915__create_magic_parameters.sql 를 magic-card 로 옮긴 것이다. V087 이 구현 클래스 63개를 행으로 옮겼지만 spawn 높이는 옮기지 않았으므로 magic-card 에도 같은 구멍이 있다.
--
-- 분류 B: magic-card 가 바꾼 표나 column 에 닿지 않아 원본 SQL 을 그대로 옮겼다.
-- 아래는 V099_20260915__create_magic_parameters.sql 의 내용 그대로다.
-- ---------------------------------------------------------------------------
