-- main 의 V094_20260914__split_building_body_and_effect_radius.sql 를 magic-card 로 옮긴 것이다. V105·V106·V107 이 등록한 세 건물 뒤에 온다.
--
-- 분류 B: magic-card 가 바꾼 표나 column 에 닿지 않아 원본 SQL 을 그대로 옮겼다.
-- 아래는 V094_20260914__split_building_body_and_effect_radius.sql 의 내용 그대로다.
-- ---------------------------------------------------------------------------
