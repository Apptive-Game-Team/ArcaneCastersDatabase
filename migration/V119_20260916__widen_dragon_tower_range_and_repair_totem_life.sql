-- main 의 V101_20260915__widen_dragon_tower_range_and_repair_totem_life.sql 를 magic-card 로 옮긴 것이다. V106·V108 이 등록한 두 행의 값만 바꾼다.
--
-- 분류 B: magic-card 가 바꾼 표나 column 에 닿지 않아 원본 SQL 을 그대로 옮겼다.
-- 아래는 V101_20260915__widen_dragon_tower_range_and_repair_totem_life.sql 의 내용 그대로다.
-- ---------------------------------------------------------------------------
